...
<div class="card">
    <div class="card-body text-center">
        ...
        <?php echo Form::open(array('method'=>'POST','class'=>'form','url'=>'/tambahbarang')); ?>
        ...
        <div class="form-floating mb-3" style=" margin: 30px">
            <?php echo Form::text('satuan','', ['placeholder'=>'Satuan','class'=>'form-control','id'=>'floatingInput','required','autofocus','autocomplete'=>'off']); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Applications\orion2\resources\views/tambahBarang.blade.php ENDPATH**/ ?>